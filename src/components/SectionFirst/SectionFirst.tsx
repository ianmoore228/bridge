      ...
      <div className={styles.wrapper}>
        <div className={styles.containerLeft}>
          ...
          <p className={styles.text}>
            ...
            апартаменты, коммерческие пространства и всю инфраструктуру в единую
            цифровую экосистему, где каждый контакт с вашей компанией усиливает
            имидж и лояльность, а качество жизни резидентов поднимается на новый
            уровень.
          </p>
          </div>
        </div>
